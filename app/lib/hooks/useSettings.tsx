...
export function useSettings() {
  ...
  useEffect(() => {
    ...
    const savedLocalDeviceTunnels = Cookies.get('isLocalDeviceTunnelsEnabled');

    if (savedLocalDeviceTunnels) {
      isLocalDeviceTunnelsEnabled.set(savedLocalDeviceTunnels === 'true');
    }
  ...
  const isLocalDeviceTunnels = useStore(isLocalDeviceTunnelsEnabled);

  const enableLocalDeviceTunnels = useCallback((enabled: boolean) => {
    isLocalDeviceTunnelsEnabled.set(enabled);
    Cookies.set('isLocalDeviceTunnelsEnabled', String(enabled));
  }, []);
  ...
  return {
    ...
    isLocalModel,
    enableLocalModels,
    isLocalDeviceTunnels,
    enableLocalDeviceTunnels,
  };
}
